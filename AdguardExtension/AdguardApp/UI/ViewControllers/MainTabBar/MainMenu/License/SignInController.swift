...
class SignInController: UIViewController {
    ...
    private func userNotFound() {
        let message = String(format: String.localizedString("user_not_found_message"), "https://adguardaccount.com") // This link is not active and should not be processed via forwarder
